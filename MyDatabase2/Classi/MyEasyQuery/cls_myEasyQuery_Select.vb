Public Class cls_myEasyQuery_Select
...
#Region "costruttore"
    ...
    Public Sub New()
        MyBase.New()
        MyBase._TipoQuery = en_TipoQuery.mySELECT
    End Sub
...
#Region "Metodi"
    ...
    Public Overloads Function eseguiQuery(Optional TipoRisultato As en_TipoRisultatoQuery = en_TipoRisultatoQuery.DataTable) As Object
